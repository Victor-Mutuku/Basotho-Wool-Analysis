...
This project focuses on cleaning, analyzing, and visualizing the Basotho Wool trade dataset to understand export trends, seasonal patterns, and the relationship between trade value and export volume over time. The workflow demonstrates data inspection, preprocessing, and multi-chart exploratory analysis.
...
Data Cleaning & Preprocessing: handling missing values, cross-column imputation, median filling
